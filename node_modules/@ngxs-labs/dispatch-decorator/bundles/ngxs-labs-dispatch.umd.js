    ...
    ***************************************************************************** */
    ...
    var ActionCompleter = /** @class */ (function () {
        function ActionCompleter() {
            this.cancelUncompleted$ = new rxjs.Subject();
        }
        /**
    ...
    function unwrapObservable(wrapped, actionCompleter) {
        ...
        if (actionCompleter !== null) {
            wrapped = wrapped.pipe(operators.takeUntil(actionCompleter.cancelUncompleted$));
        }
        wrapped.subscribe({
            next: (/**
             * @param {?} actionOrActions
    ...
    function distributeActions(wrapped, actionCompleter) {
        if (rxjs.isObservable(wrapped)) {
            return unwrapObservable(wrapped, actionCompleter);
        }
        if (core.ɵisPromise(wrapped)) {
    ...
    exports.NgxsDispatchPluginModule = NgxsDispatchPluginModule;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ngxs-labs-dispatch.umd.js.map
